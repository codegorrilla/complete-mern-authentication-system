...
const ResetPassword = () => {
  ...
  //submit the password reset email
  ...
  //handler function for OTP when we submit it
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {!isEmailSent && (
        ...
        >
          ...
          <button className="w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 rounded-full text-white mt-3">
            Submit
          </button>
        </form>
      )}
